...
public class Day03Benchmark
{
	...
	public Day03Benchmark()
	{
		_input = Helpers.GetInput("Day03.txt");
	}
	...
	public int Part1()
	{
		...
		var inputLineSpan = _input.Lines[0].AsSpan();
		...
		for (var i = 1; i < _input.Lines.Length; i++)
		{
			inputLineSpan = _input.Lines[i].AsSpan();
			...
			Part1_ValidatePartNumbersAndSum(
				ref total,
	...
	// ReSharper disable once CognitiveComplexity
	private static void Part1_ValidatePartNumbersAndSum(
		ref int total,
	...
	private static void Part2_ValidateGearsAndSum(
		ref int total,
		...
		scoped Span<PartNumberDescriptor> lookAheadPartNumbersBuffer)
	{
		foreach (var gearIndex in symbolsBuffer)
		{
			...
			Part2_ValidateHorizontalAdjacentGearByPartNumberBuffer(
			...
			Part2_ValidateGearByPartNumberBuffer(
				ref adjacentPartNumbersCount,
				ref gearRatio,
				gearIndex,
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private static void Part2_ValidateHorizontalAdjacentGearByPartNumberBuffer(
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private static void Part2_ValidateGearByPartNumberBuffer(
		ref int adjacentPartNumbersCount,
		ref int gearRatio,
		int gearIndex,
		scoped ref Span<PartNumberDescriptor> partNumberBuffer)
