...
public class Day11Benchmark
{
	...
	public Day11Benchmark()
	{
		_input = Helpers.GetInput("Day11.txt");
	}
	...
	public int Part1()
	{
		var width = _input.Lines[0].Length + 1;
		...
		var yOffset = 0;
		for (var y = 0; y < _input.Lines.Length; y++)
		{
			var inputLineSpan = _input.Lines[y].AsSpan();
